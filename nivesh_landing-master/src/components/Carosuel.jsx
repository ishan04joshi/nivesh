...
const Slider = ({
  ...
  useEffect(() => {
    var interval = setInterval(() => {
      const last = activeItem === positions.length - constraint;
      if (last) return setActiveItem(0);
  ...
  }, [activeItem, positions.length, constraint, paused]);
    ...
    <>
      ...
      <Flex w={`${itemWidth}px`} mt={`${gap / 2}px`} mx="auto">
        <Button
          ...
          minW={0}
        >
          <ChevronLeftIcon boxSize={9} color="blue.400" />
        </Button>
        ...
        <Button
          ...
          minW={0}
        >
          <ChevronRightIcon boxSize={9} color="blue.400" />
        </Button>
      </Flex>
    </>
  );
